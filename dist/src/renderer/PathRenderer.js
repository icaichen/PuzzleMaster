 ...
 * - 起/终点：特殊标记
 */
import { COLORS, drawParchmentBg } from './PuzzleRenderer';
export class PathRenderer {
    draw(ctx, logicalW, logicalH, rs) {
        ...
        // ── 夜间星空背景 ──
        const bgGrad = ctx.createRadialGradient(ox + gridSize * cs / 2, oy + gridSize * cs / 2, 10, ox + gridSize * cs / 2, oy + gridSize * cs / 2, gridSize * cs);
