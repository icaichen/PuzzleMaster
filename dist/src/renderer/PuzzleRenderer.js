...
export function setupRender(ctx, canvasW, canvasH, scale) {
...
export function teardownRender(ctx) {
    ctx.restore();
}
// ═══════════════════════════════════════════════════════════
//  颜色常量 — Layton 暖色调
...
/** 绘制四角星 sparkle */
export function drawSparkle(ctx, cx, cy, size, alpha) {
    ctx.save();
...
//# sourceMappingURL=PuzzleRenderer.js.map