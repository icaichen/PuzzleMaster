export class ConstraintTransferLayout {
    constructor() {
        this.callbacks = null;
        // State
    ...
    render(params) {
        this.logic = params.puzzle.initial_state;
    ...
    draw() {
        ...
        this.logic.entities.forEach(entityId => {
            ...
            if (this.entityLocations[entityId] === 'LOC_START')
                leftBank.appendChild(el);
            else if (this.entityLocations[entityId] === 'LOC_END')
                rightBank.appendChild(el);
            else if (this.entityLocations[entityId] === 'CARRIER')
    ...
    checkWin() {
        const allAtEnd = this.logic.entities.every(e => this.entityLocations[e] === 'LOC_END' || (this.entityLocations[e] === 'CARRIER' && this.carrierLocation === 'LOC_END'));
        if (allAtEnd) {
            setTimeout(() => {
                alert("You won!");
                if (this.callbacks)
...
//# sourceMappingURL=ConstraintTransferLayout.js.map