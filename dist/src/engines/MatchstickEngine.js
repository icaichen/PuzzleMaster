...
export class MatchstickEngine {
    constructor() {
        this.type = PuzzleType.MATCHSTICK;
        this.isBank = false;
    ...
    generate(difficulty, seed) {
        ...
        const story = storyGen.generate(PuzzleType.MATCHSTICK, `火柴棒谜题 · ${puzzle.moves === 1 ? '一星' : '二星'}`, undefined, `移动 ${puzzle.moves} 根火柴棒，使等式成立：\n\n    ${puzzle.equation}\n\n（火柴棒数字按七段数码管显示）`);
        return {
...
//# sourceMappingURL=MatchstickEngine.js.map